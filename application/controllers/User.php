...
class User extends CI_Controller
{
    ...
    public function datausers()
    {
        ...
        foreach ($query->result() as $r) {
            $status = $r->aktif == '1' ? "<span class='btn   btn-xs  btn-primary'>Aktif</span>" : "<span class='btn  btn-xs btn-danger'>Blokir</span>";
    ...
    public function userdetail()
    {
        ...
        $status = $query->row()->aktif == '1' ? "<span class='btn   btn-xs  btn-primary'>Aktif</span>" : "<span class='btn  btn-xs btn-danger'>Blokir</span>";
        $result = array(
