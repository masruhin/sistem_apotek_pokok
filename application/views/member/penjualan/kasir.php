...
<html class="fixed sidebar-left-collapsed">
  ...
  <body class="bgbody">
          ...
          <div id="userbox" class="userbox">
            ...
            <div class="dropdown-menu">
              <ul class="list-unstyled">
                <li class="divider"></li>
                <li>
                  <a role="menuitem" tabindex="-1" href="<?php echo base_url() ?>password"><i class="fa fa-lock"></i>
                    Ganti Password</a>
                </li>
                <li>
                  ...
                  <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="thumbnail"
                      ...
                      <span class="mg-title nama_produk">
                        <?php if ($post['jenis'] == 'racikan') echo "<b>[racikan]</b>"; ?>
    ...
    <div class="modal fade" id="modal-pembeli" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <section class="panel panel-primary">
            ...
            <div class="panel-body">
              <div class="modal-wrapper">
                ...
                <div class="form-group keterangan_hold">
                  <div class="col-sm-12">
                    <textarea rows="2" placeholder="Tambahkan Keterangan" maxlength="100" class="form-control"
                      name="keterangan_hold"></textarea>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="modal fade" id="modal-hold" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <section class="panel panel-primary">
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-payment" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
          ...
          <section class="panel panel-primary">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="btn-group-vertical col-md-12">
                    ...
                    <button type="button" onclick="cash(this)" data-nominal="5000" class="btn btn-primary">Rp
                      5.000</button>
                    <button type="button" onclick="cash(this)" data-nominal="10000" class="btn btn-primary">Rp
                      10.000</button>
                    <button type="button" onclick="cash(this)" data-nominal="20000" class="btn btn-primary">Rp
                      20.000</button>
                    <button type="button" onclick="cash(this)" data-nominal="50000" class="btn btn-primary">Rp
                      50.000</button>
                    <button type="button" onclick="cash(this)" data-nominal="100000" class="btn btn-primary">Rp
                      100.000</button>
                    <button type="button" onclick="cash(this)" data-nominal="200000" class="btn btn-primary">Rp
                      200.000</button>
                  ...
                  <section class="panel">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="totaldibayar[]" id="totaldibayar1" value="0"
                            class="form-control mask_price" required />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label"></label>
                          <textarea rows="2" placeholder="Catatan Pembayaran" class="form-control"
                    ...
                    <div class="row" id="tambah1">
                      <div class="col-md-12">
                        <div class="form-group">
                          <button type="button" class="mb-xs mt-xs mr-xs btn btn-primary btn-block" id="btntambah1"><i
                              class="fa fa-plus"></i> Tambah Cara Bayar</button>
                        </div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section class="panel" id="formbayar2" style="display:none;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label">Total Dibayar</label>
                          <input type="text" name="totaldibayar[]" id="totaldibayar2" value="0"
                            class="form-control mask_price" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
            ...
            <footer class="panel-footer">
                ...
                <div class="col-md-12">
                  <table class="table table-hover mb-none">
                    <tr>
                      ...
                      <th>
                        <h4 class="text-dark">Rp <span id="GrandTotalDibayar">0</span></h4>
                      </th>
                    </tr>
                    <tr>
                      <th>
                      ...
                      <th>
                        <h4 class="text-dark" id="TotalKuantiti"></h4>
                      </th>
                      <th>
                        <h4>Kembalian</h4>
                      </th>
                      <th>
                        <h4 class="text-dark">Rp <span id="Kembalian">0</span></h4>
                      </th>
                    </tr>
                  </table>
                </div>
              ...
              <div class="row">
                <div class="col-md-12 text-right">
                  <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary btn-lg btn-block" id="submitPayment"
    ...
    function keranjang() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.datasub != '') {
            var datarow =
              '<table class="table table-responsive table-bordered table-hover table-striped dataTable no-footer" style="font-size:11px;">';
            datarow += '<thead>';
            datarow +=
              '<tr><th>Produk</th><th>Kuantiti</th><th style="min-width:70px;">Harga</th><th style="min-width:70px;">Diskon</th><th style="min-width:90px;">Total</th><th></th></tr></thead><tbody>';
            $.each(response.datasub, function(i, itemsub) {
              datarow += '<tr>';
              ...
              datarow += '<input type="text" readonly style="background-color:#fff;" value="' + itemsub
                .kuantiti + '" data-kode="' + itemsub.id +
                '"  class="spinner-input form-control" maxlength="3">';
              datarow += '<div class="spinner-buttons input-group-btn">';
              datarow += '<button type="button"   id="tambah' + itemsub.id +
                '" onclick="tambah(this)" data-kode="' + itemsub.id + '" class="btn btn-sm spinner-up">';
              datarow += '<i class="fa fa-angle-up"></i>';
              datarow += '</button>';
              datarow += '<button type="button" id="kurang' + itemsub.id +
                '" onclick="kurang(this)" data-kode="' + itemsub.id + '" class="btn btn-sm spinner-down">';
              ...
              datarow += '<td><a class="btn btn-danger btn-xs"  onclick="hapus(this)" data-kode="' + itemsub
