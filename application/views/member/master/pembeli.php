                ...
                <section class="panel">
                    <header class="panel-heading">
                        <div class="row show-grid">
                            ...
                            <?php
                            echo level_user('master', 'pembeli', $this->session->userdata('kategori'), 'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-primary" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>' : '';
                            ?>
                        </div>
                    </header>
