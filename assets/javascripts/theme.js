...
(function (theme, $) {
	...
	var Skeleton = {
		...
		fixScroll: function () {
			...
			$window.on(
				"sidebar-left-opened sidebar-right-toggle",
				function (e, data) {
		...
		eventsContentMenu: function () {
			...
			var close = function (e) {
				if (
					!!e &&
					!!e.target &&
					!$(e.target).closest(".inner-menu-collapse").get(0) &&
					($(e.target).closest(".inner-menu").get(0) ||
						!$(e.target).closest("html").get(0))
				) {
					return false;
				}
...
(function (theme, $) {
	...
	GMapBuilder.prototype = {
		...
		getCode: function () {
			this.$getCodeModal
				.find(".modal-body pre")
				.html(this.generate().replace(/</g, "&lt;").replace(/>/g, "&gt;"));
		},
